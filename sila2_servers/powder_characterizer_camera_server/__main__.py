...
def main(
    ...
    port: int = Option(50064, "-p", "--port", envvar="POWDER_CAMERA_SILA_PORT", help="The port"),
    ...
    fake: bool = Option(False, "--fake", help="Use a generated fake camera image"),
):
    # validate parameters
    ...
    driver = None
    if fake:
        from .drivers.fake import FakePowderCharacterizerCamera

        driver = FakePowderCharacterizerCamera()
    server = Server(
